...
def runNodeosAndGetOutput(myTimeout=3):
    ...
    cmd="programs/nodeos/nodeos --config-dir etc/eosio/node_bios --data-dir validate-dirty-db.py/lib/node_bios --verbose-http-errors --http-validate-host=false --resource-monitor-not-shutdown-on-threshold-exceeded"
    Print("cmd: %s" % (cmd))
