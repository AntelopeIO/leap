...
parser.add_argument("--save-json", type=bool, default=False, help="Whether to save json output of stats")
parser.add_argument("--json-path", type=str, default="data.json", help="Path to save json output")
