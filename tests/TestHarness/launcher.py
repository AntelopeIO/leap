...
class cluster_generator:
    ...
    def init_genesis(self):
        ...
        genesis['max_block_cpu_usage']['initial_configuration'] = self.args.max_block_cpu_usage
        genesis['max_transaction_cpu_usage']['initial_configuration'] = self.args.max_transaction_cpu_usage
        return genesis
