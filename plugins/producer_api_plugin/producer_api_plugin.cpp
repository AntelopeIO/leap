   ...
   app().get_plugin<http_plugin>().add_api(
      {
         ...
         CALL_WITH_400(producer,
                       ...
                       INVOKE_V_R(producer, update_runtime_options, producer_plugin::runtime_options),
                       201),
         CALL_WITH_400(producer,
                       producer,
                       add_greylist_accounts,
                       INVOKE_V_R(producer, add_greylist_accounts, producer_plugin::greylist_params),
                       201),
         CALL_WITH_400(producer,
                       producer,
         ...
         CALL_WITH_400(producer,
                       ...
                       INVOKE_V_R(producer, set_whitelist_blacklist, producer_plugin::whitelist_blacklist),
                       201),
         CALL_WITH_400(producer, producer, get_integrity_hash, INVOKE_R_V(producer, get_integrity_hash), 201),
         CALL_ASYNC(producer,
                    producer,
                    create_snapshot,
                    producer_plugin::snapshot_information,
                    INVOKE_R_V_ASYNC(producer, create_snapshot),
                    201),
         CALL_WITH_400(producer,
                       producer,
                       get_scheduled_protocol_feature_activations,
                       INVOKE_R_V(producer, get_scheduled_protocol_feature_activations),
                       201),
         CALL_WITH_400(producer,
                       producer,
