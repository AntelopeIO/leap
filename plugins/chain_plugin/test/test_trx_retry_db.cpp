...
BOOST_AUTO_TEST_CASE(trx_retry_logic)
{
   ...
   try {
      ...
      std::thread app_thread([&]() { appbase::app().exec(); });
      ...
      trx_retry.track_transaction(
         ...
         [&trx_6_variant](const std::variant<fc::exception_ptr, std::unique_ptr<fc::variant>>& result) {
            BOOST_REQUIRE(std::holds_alternative<std::unique_ptr<fc::variant>>(result));
            BOOST_CHECK(!!std::get<std::unique_ptr<fc::variant>>(result));
            trx_6_variant = true;
         });
      ...
      trx_retry.track_transaction(
         ...
         [&trx_8_variant](const std::variant<fc::exception_ptr, std::unique_ptr<fc::variant>>& result) {
            BOOST_REQUIRE(std::holds_alternative<std::unique_ptr<fc::variant>>(result));
            BOOST_CHECK(!!std::get<std::unique_ptr<fc::variant>>(result));
            trx_8_variant = true;
         });
      ...
      trx_retry.track_transaction(
         ...
         [&trx_10_variant](const std::variant<fc::exception_ptr, std::unique_ptr<fc::variant>>& result) {
            BOOST_REQUIRE(std::holds_alternative<std::unique_ptr<fc::variant>>(result));
            BOOST_CHECK(!!std::get<std::unique_ptr<fc::variant>>(result));
            trx_10_variant = true;
         });
      ...
      trx_retry.track_transaction(
         ...
         [&trx_11_variant](const std::variant<fc::exception_ptr, std::unique_ptr<fc::variant>>& result) {
            BOOST_REQUIRE(std::holds_alternative<std::unique_ptr<fc::variant>>(result));
            BOOST_CHECK(!!std::get<std::unique_ptr<fc::variant>>(result));
            trx_11_variant = true;
         });
