...
inline void to_variant(const params::permission_level& a, fc::variant& v) {
   if (a.permission.empty()) {
      ...
      v = mutable_variant_object()("actor", a.actor.to_string())("permission", a.permission.to_string());
   }
}
...
FC_REFLECT(eosio::chain_apis::account_query_db::get_accounts_by_authorizers_result::account_result,
