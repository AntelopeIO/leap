   ...
   app().get_plugin<http_plugin>().add_api(
      {
         ...
         //        INVOKE_R_R_R_R(net_mgr, sign_transaction, chain::signed_transaction,
         //        flat_set<public_key_type>, chain::chain_id_type), 201),
         CALL_WITH_400(net, net_mgr, connect, INVOKE_R_R(net_mgr, connect, std::string), 201),
         CALL_WITH_400(net, net_mgr, disconnect, INVOKE_R_R(net_mgr, disconnect, std::string), 201),
         CALL_WITH_400(net, net_mgr, status, INVOKE_R_R(net_mgr, status, std::string), 201),
         CALL_WITH_400(net, net_mgr, connections, INVOKE_R_V(net_mgr, connections), 201),
