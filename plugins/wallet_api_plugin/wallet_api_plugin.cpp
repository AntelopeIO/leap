...
#define INVOKE_R_R_R_R(api_handle, call_name, in_param0, in_param1, in_param2)                               \
   ...
   auto result = api_handle.call_name(                                                                       \
      params.at(0).as<in_param0>(), params.at(1).as<in_param1>(), params.at(2).as<in_param2>());
...
void wallet_api_plugin::plugin_startup()
{
   ...
   app().get_plugin<http_plugin>().add_api(
      { CALL_WITH_400(wallet, wallet_mgr, set_timeout, INVOKE_V_R(wallet_mgr, set_timeout, int64_t), 200),
        ...
        CALL_WITH_400(
           wallet, wallet_mgr, unlock, INVOKE_V_R_R(wallet_mgr, unlock, std::string, std::string), 200),
        CALL_WITH_400(wallet,
                      wallet_mgr,
                      import_key,
        ...
        CALL_WITH_400(wallet,
                      wallet_mgr,
                      create_key,
                      INVOKE_R_R_R(wallet_mgr, create_key, std::string, std::string),
                      201),
