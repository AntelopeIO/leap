...
class compressed_file_datastream {
 public:
   explicit compressed_file_datastream(compressed_file& cf)
       : cf(cf) {}
...
inline compressed_file_datastream compressed_file::create_datastream() { return compressed_file_datastream(*this); }
