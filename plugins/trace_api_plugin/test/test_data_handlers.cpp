...
BOOST_AUTO_TEST_CASE(empty_data) {
   auto                                           action = action_trace_v0{0, "alice"_n, "alice"_n, "foo"_n, {}, {}};
...
BOOST_AUTO_TEST_CASE(empty_data_v1) {
   auto action = action_trace_v1{{0, "alice"_n, "alice"_n, "foo"_n, {}, {}}, {}};
   std::variant<action_trace_v0, action_trace_v1> action_trace_t = action;
   abi_data_handler                               handler(exception_handler{});
...
BOOST_AUTO_TEST_CASE(no_abi) {
   auto action = action_trace_v0{0, "alice"_n, "alice"_n, "foo"_n, {}, {0x00, 0x01, 0x02, 0x03}};
   std::variant<action_trace_v0, action_trace_v1> action_trace_t = action;
   abi_data_handler                               handler(exception_handler{});
...
BOOST_AUTO_TEST_CASE(no_abi_v1) {
   auto action =
       action_trace_v1{{0, "alice"_n, "alice"_n, "foo"_n, {}, {0x00, 0x01, 0x02, 0x03}}, {0x04, 0x05, 0x06, 0x07}};
   std::variant<action_trace_v0, action_trace_v1> action_trace_t = action;
   abi_data_handler                               handler(exception_handler{});
...
BOOST_AUTO_TEST_CASE(basic_abi) {
   ...
   fc::variant expected = fc::mutable_variant_object()("a", 0)("b", 1)("c", 2)("d", 3);
...
BOOST_AUTO_TEST_CASE(basic_abi_insufficient_data) {
   auto action = action_trace_v0{0, "alice"_n, "alice"_n, "foo"_n, {}, {0x00, 0x01, 0x02}};
