...
private:
   ...
   friend compact_signature            signature_from_ecdsa(const EC_KEY*          key,
...
FC_REFLECT_DERIVED(fc::crypto::r1::public_key_shim,
                   (fc::crypto::shim<fc::crypto::r1::public_key_data>),
                   BOOST_PP_SEQ_NIL)
FC_REFLECT_DERIVED(fc::crypto::r1::signature_shim,
                   (fc::crypto::shim<fc::crypto::r1::compact_signature>),
                   BOOST_PP_SEQ_NIL)
FC_REFLECT_DERIVED(fc::crypto::r1::private_key_shim,
                   (fc::crypto::shim<fc::crypto::r1::private_key_secret>),
                   BOOST_PP_SEQ_NIL)
