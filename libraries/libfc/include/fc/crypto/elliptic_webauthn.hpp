...
struct eq_comparator<webauthn::signature> {
   static bool apply(const webauthn::signature& a, const webauthn::signature& b) { return a == b; }
};
...
struct eq_comparator<webauthn::public_key> {
   static bool apply(const webauthn::public_key& a, const webauthn::public_key& b) { return a == b; }
};
