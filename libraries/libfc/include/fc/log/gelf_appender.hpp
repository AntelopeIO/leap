...
public:
   struct config {
      ...
      string host = "fc"; // the name of the host, source or application that sent this message (just passed
                          // through to GELF server)
...
FC_REFLECT(fc::gelf_appender::config, (endpoint)(host)(user_fields))
