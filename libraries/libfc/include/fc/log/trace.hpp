...
#define fc_create_trace_with_id(TRACE_STR, TRACE_ID)                                                                   \
   ::fc::zipkin_config::is_enabled() ? ::fc::optional_trace{ ::std::optional<::fc::zipkin_trace>(                      \
                                          ::std::in_place, ::fc::zipkin_span::to_id(TRACE_ID), (TRACE_STR)) }          \
                                     : ::fc::optional_trace{};
...
#define fc_create_span(TRACE_VARNAME, SPAN_STR)                                                                        \
   ((TRACE_VARNAME) && ::fc::zipkin_config::is_enabled()) ? (TRACE_VARNAME).opt->create_span((SPAN_STR))               \
