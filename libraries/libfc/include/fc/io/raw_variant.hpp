...
public:
   ...
   virtual void handle(const blob& v) const { fc::raw::pack(s, v); }
...
inline void unpack(Stream& s, variant& v) {
   ...
   switch (t) {
      ...
      default: FC_THROW_EXCEPTION(parse_error_exception, "Unknown Variant Type ${t}", ("t", t));
   }
}
