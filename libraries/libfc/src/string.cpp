...
string::string() {}
string::string(const fc::string& c)
   : my(*c.my)
{
}
...
size_t string::find(char c, size_t p) const
{
   return my->find(c, p);
}
...
size_t string::rfind(char c, size_t p) const
{
   return my->rfind(c, p);
}
size_t string::rfind(const char* c, size_t p) const
{
   return my->rfind(c, p);
}
...
size_t string::find_first_of(const fc::string& str, size_t pos /* = 0 */) const
{
