...
void variant::clear() {
   switch (get_type()) {
      case object_type: delete *reinterpret_cast<variant_object**>(this); break;
      case array_type: delete *reinterpret_cast<variants**>(this); break;
      case string_type: delete *reinterpret_cast<string**>(this); break;
      case blob_type: delete *reinterpret_cast<blob**>(this); break;
      default: break;
   }
   set_variant_type(this, null_type);
}
   ...
   switch (v.get_type()) {
      ...
      case blob_type:
         *reinterpret_cast<blob**>(this) = new blob(**reinterpret_cast<const const_blob_ptr*>(&v));
         set_variant_type(this, blob_type);
         return;
      default: memcpy(this, &v, sizeof(v));
   }
}
...
void variant::visit(const visitor& v) const {
   switch (get_type()) {
      case null_type: v.handle(); return;
      case int64_type: v.handle(*reinterpret_cast<const int64_t*>(this)); return;
      case uint64_type: v.handle(*reinterpret_cast<const uint64_t*>(this)); return;
      case double_type: v.handle(*reinterpret_cast<const double*>(this)); return;
      case bool_type: v.handle(*reinterpret_cast<const bool*>(this)); return;
      case string_type: v.handle(**reinterpret_cast<const const_string_ptr*>(this)); return;
      case array_type: v.handle(**reinterpret_cast<const const_variants_ptr*>(this)); return;
      case object_type: v.handle(**reinterpret_cast<const const_variant_object_ptr*>(this)); return;
      case blob_type: v.handle(**reinterpret_cast<const const_blob_ptr*>(this)); return;
      default: FC_THROW_EXCEPTION(assert_exception, "Invalid Type / Corrupted Memory");
   }
}
...
int64_t variant::as_int64() const {
   switch (get_type()) {
      case string_type: return to_int64(**reinterpret_cast<const const_string_ptr*>(this));
      case double_type: return int64_t(*reinterpret_cast<const double*>(this));
      case int64_type: return *reinterpret_cast<const int64_t*>(this);
...
uint64_t variant::as_uint64() const {
   try {
      switch (get_type()) {
         case string_type: return to_uint64(**reinterpret_cast<const const_string_ptr*>(this));
         case double_type: return static_cast<uint64_t>(*reinterpret_cast<const double*>(this));
         case int64_type: return static_cast<uint64_t>(*reinterpret_cast<const int64_t*>(this));
...
double variant::as_double() const {
   switch (get_type()) {
      case string_type: return to_double(**reinterpret_cast<const const_string_ptr*>(this));
      case double_type: return *reinterpret_cast<const double*>(this);
      case int64_type: return static_cast<double>(*reinterpret_cast<const int64_t*>(this));
...
bool variant::as_bool() const {
   switch (get_type()) {
      ...
      case double_type: return *reinterpret_cast<const double*>(this) != 0.0;
      case int64_type: return *reinterpret_cast<const int64_t*>(this) != 0;
...
string variant::as_string() const {
   switch (get_type()) {
      ...
      case double_type: return to_string(*reinterpret_cast<const double*>(this));
      case int64_type: return to_string(*reinterpret_cast<const int64_t*>(this));
      case uint64_type: return to_string(*reinterpret_cast<const uint64_t*>(this));
      case bool_type: return *reinterpret_cast<const bool*>(this) ? "true" : "false";
      case blob_type:
...
blob variant::as_blob() const {
   switch (get_type()) {
      ...
      case array_type:
         FC_THROW_EXCEPTION(bad_cast_exception, "Invalid cast from ${type} to Blob", ("type", get_type()));
      default: return blob({ std::vector<char>((char*)&_data, (char*)&_data + sizeof(_data)) });
   }
}
...
size_t variant::estimated_size() const {
   switch (get_type()) {
      ...
      case uint64_type:
      case double_type:
      case bool_type: return sizeof(*this);
      case string_type: return as_string().length() + sizeof(string) + sizeof(*this);
      case array_type: {
      ...
      case object_type: return get_object().estimated_size() + sizeof(*this);
      case blob_type: return sizeof(blob) + get_blob().data.size() + sizeof(*this);
      default: FC_THROW_EXCEPTION(assert_exception, "Invalid Type / Corrupted Memory");
   }
}
