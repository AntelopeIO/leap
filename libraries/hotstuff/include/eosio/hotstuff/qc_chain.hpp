...
namespace eosio::hotstuff {
   ...
   public:
      ...
      hs_proposal_message test_create_proposal(const block_id_type& block_id);

      // UNIT TESTING ONLY; do not call from chain_pacemaker. no need to synchronize.
      // This is called by the test_pacemaker to receive a new proposal generated by another qc_chain
      void test_receive_proposal(const hs_proposal_message& proposal);
   ...
   private:
      ...
      hs_proposal_message create_proposal(const block_id_type& block_id);
