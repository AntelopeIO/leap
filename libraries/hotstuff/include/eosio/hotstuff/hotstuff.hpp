...
namespace eosio::hotstuff {
   ...
   struct hs_message {
      std::variant<hs_vote_message, hs_new_view_message> msg;
   };
   ...
   struct finalizer_state {
      ...
      std::map<fc::sha256, hs_proposal> proposals;
...
FC_REFLECT(eosio::hotstuff::hs_proposal, (proposal_id)(block_id)(parent_id)(final_on_qc)(justify)(phase_counter));
