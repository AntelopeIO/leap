...
#define VISIT_OP(opcode, name, nameString, Imm, ...)                                                         \
   case t_##name:                                                                                            \
      ...
      break;
               ENUM_NONCONTROL_OPERATORS(VISIT_OP)
#undef VISIT_OP
            default: parseErrorf(state, state.nextToken, "expected opcode"); throw RecoverParseException();
         }
...
FunctionDef parseFunctionDef(ModuleParseState& state, const Token* funcToken) {
   ...
   state.postTypeCallbacks.push_back([functionIndex,
                                      functionDefIndex,
                                      firstBodyToken,
                                      localNameToIndexMap,
                                      localDisassemblyNames,
                                      unresolvedFunctionType](ModuleParseState& state) {
      ...
      state.postDeclarationCallbacks.push_back([functionIndex,
                                                functionDefIndex,
                                                firstBodyToken,
                                                localNameToIndexMap,
                                                localDisassemblyNames,
