...
class permission_object : public chainbase::object<permission_object_type, permission_object>
{
   ...
   account_name owner;   ///< the account this permission belongs to (should not be changed within a chainbase
                         ///< modifier lambda)
   permission_name name; ///< human-readable name for the permission (should not be changed within a chainbase
                         ///< modifier lambda)
    ...
    *
    * Permissions are organized hierarchically such that a parent permission is strictly more powerful than
    * its children/grandchildren. This method checks whether this permission is of greater or equal power
   ...
   bool satisfies(const permission_object& other, const Index& permission_index) const
   {
      ...
      // If this permission matches other, or is the immediate parent of other, then this permission satisfies
      // other
      if (id == other.id || id == other.parent)
         return true;

      // Walk up other's parent tree, seeing if we find this permission. If so, this permission satisfies
      // other
