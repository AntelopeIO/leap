...
public:
   ...
   static builtin_protocol_feature make_default_builtin_protocol_feature(
...
FC_REFLECT_DERIVED(eosio::chain::builtin_protocol_feature,
                   (eosio::chain::protocol_feature_base),
