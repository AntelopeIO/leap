...
struct block_header_state_core {
   ...
   std::optional<uint32_t> final_on_strong_qc_block_height; // the block height of
                                                            ...
                                                            // become irreversible
                                                            // if the associated block
                                                            // header was to achieve a
                                                            // strong QC.
   std::optional<uint32_t> last_qc_block_height; // the block height of the block that
                                                 // is referenced as the last QC block
