...
struct controller_impl {
   ...
   std::optional<chain::chain_pacemaker> pacemaker;
...
void controller::create_pacemaker(std::set<chain::account_name> my_producers, chain::bls_pub_priv_key_map_t finalizer_keys, fc::logger& hotstuff_logger) {
...
void controller::register_pacemaker_bcast_function(std::function<void(const std::optional<uint32_t>&, const chain::hs_message&)> bcast_hs_message) {
...
void controller::register_pacemaker_warn_function(std::function<void(uint32_t, chain::hs_message_warning)> warn_hs_message) {
   EOS_ASSERT( my->pacemaker, misc_exception, "chain_pacemaker not created" );
...
void controller::get_finalizer_state( chain::finalizer_state& fs ) const {
   EOS_ASSERT( my->pacemaker, misc_exception, "chain_pacemaker not created" );
   my->pacemaker->get_state(fs);
}

// called from net threads
void controller::notify_hs_message( const uint32_t connection_id, const chain::hs_message& msg ) {
