...
eosvmoc_runtime::eosvmoc_runtime(const boost::filesystem::path data_dir,
...
std::unique_ptr<wasm_instantiated_module_interface> eosvmoc_runtime::instantiate_module(
