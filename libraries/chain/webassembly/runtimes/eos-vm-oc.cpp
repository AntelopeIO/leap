...
thread_local std::unique_ptr<eosvmoc::executor> eosvmoc_runtime::exec {};
thread_local eosvmoc::memory eosvmoc_runtime::mem { wasm_constraints::maximum_linear_memory/wasm_constraints::wasm_page_size };
