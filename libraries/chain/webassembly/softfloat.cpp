...
// float relops
bool interface::_eosio_f32_eq(float a, float b) const {
   return ::f32_eq(to_softfloat32(a), to_softfloat32(b));
}
bool interface::_eosio_f32_ne(float a, float b) const {
   return !::f32_eq(to_softfloat32(a), to_softfloat32(b));
}
bool interface::_eosio_f32_lt(float a, float b) const {
   return ::f32_lt(to_softfloat32(a), to_softfloat32(b));
}
bool interface::_eosio_f32_le(float a, float b) const {
...
// double relops
bool interface::_eosio_f64_eq(double a, double b) const {
   return ::f64_eq(to_softfloat64(a), to_softfloat64(b));
}
bool interface::_eosio_f64_ne(double a, double b) const {
   return !::f64_eq(to_softfloat64(a), to_softfloat64(b));
}
bool interface::_eosio_f64_lt(double a, double b) const {
   return ::f64_lt(to_softfloat64(a), to_softfloat64(b));
}
bool interface::_eosio_f64_le(double a, double b) const {
