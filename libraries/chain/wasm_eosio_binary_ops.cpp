...
{
   return {
      U8(field.a), U8(field.a >> 8), U8(field.a >> 16), U8(field.a >> 24),
...
inline std::vector<U8> pack(branchtabletype field)
{
   return { U8(field.target_depth),       U8(field.target_depth >> 8),  U8(field.target_depth >> 16),
            U8(field.target_depth >> 24), U8(field.target_depth >> 32), U8(field.target_depth >> 40),
            U8(field.target_depth >> 48), U8(field.target_depth >> 56), U8(field.table_index),
            U8(field.table_index >> 8),   U8(field.table_index >> 16),  U8(field.table_index >> 24),
