...
void wasm_config::validate() const
{
   ...
   EOS_ASSERT(
      max_func_local_bytes >= 8, action_validate_exception, "max_func_local_bytes cannot be less than 8");
   EOS_ASSERT(
      max_nested_structures >= 1, action_validate_exception, "max_nested_structures cannot be less than 1");
