...
BOOST_AUTO_TEST_CASE( default_exec_window ) {
   ...
   int seq_num = 0;
   app->executor().post( priority::medium, exec_queue::read_only_safe,  [&]() { rslts[0]=seq_num; ++seq_num; } );
   ...
   app->executor().post( priority::high,   exec_queue::read_only_safe,  [&]() { rslts[3]=seq_num; ++seq_num; } );
   app->executor().post( priority::low,    exec_queue::read_only_safe,  [&]() { rslts[4]=seq_num; ++seq_num; } );
   app->executor().post( priority::low,    exec_queue::general, [&]() { rslts[5]=seq_num; ++seq_num; } );
   app->executor().post( priority::highest,exec_queue::read_only_safe,  [&]() { rslts[6]=seq_num; ++seq_num; } );
   ...
   app->executor().post( priority::lowest, exec_queue::read_only_safe, [&]() {
...
BOOST_AUTO_TEST_CASE( execute_from_read_queue ) {
   ...
   app->executor().post( priority::high,   exec_queue::read_only_safe,  [&]() { rslts[1]=seq_num; ++seq_num; } );
   app->executor().post( priority::high,   exec_queue::general, [&]() { rslts[2]=seq_num; ++seq_num; } );
   app->executor().post( priority::high,   exec_queue::read_only_safe,  [&]() { rslts[3]=seq_num; ++seq_num; } );
   app->executor().post( priority::low,    exec_queue::read_only_safe,  [&]() { rslts[4]=seq_num; ++seq_num; } );
   app->executor().post( priority::low,    exec_queue::general, [&]() { rslts[5]=seq_num; ++seq_num; } );
   app->executor().post( priority::highest,exec_queue::read_only_safe,  [&]() { rslts[6]=seq_num; ++seq_num; } );
   app->executor().post( priority::highest,exec_queue::read_only_safe,  [&]() { rslts[7]=seq_num; ++seq_num; } );
   app->executor().post( priority::high,   exec_queue::read_only_safe,  [&]() { rslts[8]=seq_num; ++seq_num; } );
...
BOOST_AUTO_TEST_CASE( execute_from_both_queues ) {
   ...
   app->executor().post( priority::medium, exec_queue::general, [&]() { rslts[1]=seq_num; ++seq_num; } );
   app->executor().post( priority::high,   exec_queue::general, [&]() { rslts[2]=seq_num; ++seq_num; } );
   app->executor().post( priority::lowest, exec_queue::read_only_safe,  [&]() { rslts[3]=seq_num; ++seq_num; } );
   app->executor().post( priority::low,    exec_queue::read_only_safe,  [&]() { rslts[4]=seq_num; ++seq_num; } );
   app->executor().post( priority::low,    exec_queue::general, [&]() { rslts[5]=seq_num; ++seq_num; } );
   app->executor().post( priority::highest,exec_queue::read_only_safe,  [&]() { rslts[6]=seq_num; ++seq_num; } );
   app->executor().post( priority::low,    exec_queue::general, [&]() { rslts[7]=seq_num; ++seq_num; } );
   app->executor().post( priority::lowest, exec_queue::read_only_safe,  [&]() { rslts[8]=seq_num; ++seq_num; } );
   app->executor().post( priority::lowest, exec_queue::read_only_safe,  [&]() { rslts[9]=seq_num; ++seq_num; } );
