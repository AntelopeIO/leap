...
#   pragma clang diagnostic pop
   ...
   struct get_blocks_result_v0 : get_blocks_result_base {
      std::optional<opaque<signed_block>> block  = {};
      std::optional<opaque<transaction_trace>> traces = {};
      std::optional<opaque<table_delta>> deltas = {};
   };
   ...
   constexpr const char* get_type_name(wasm_config*) { return "wasm_config"; }
