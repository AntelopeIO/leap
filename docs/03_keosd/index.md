...
`keosd` is distributed as part of the [Mandel software suite](https://github.com/eosnetworkfoundation/mandel). To install `keosd` just visit the [Mandel Software Installation](../00_install/index.md) section.
...
[[info | Audience]]
| `keosd` is intended to be used by Mandel developers only.
