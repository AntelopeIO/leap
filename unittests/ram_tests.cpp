...
BOOST_FIXTURE_TEST_CASE(ram_tests, eosio_system::eosio_system_tester)
{
   try {
      ...
      BOOST_REQUIRE_MESSAGE(
         table_allocation_bytes > increment_contract_bytes,
      ...
      BOOST_REQUIRE_EQUAL(success(),
                          stake(name("eosio.stake"),
                                name("testram11111"),
                                core_from_string("10.0000"),
      ...
      tester->push_action("testram11111"_n,
                          "setentry"_n,
                          "testram11111"_n,
                          mvo()("payer", "testram11111")("from", 1)("to", 10)("size", 1780 /*1910*/));
      produce_blocks(1);
      ...
      wdump((ram_bytes)(ram_usage)(initial_ram_usage)(init_bytes)(ram_usage - initial_ram_usage)(init_bytes -
                                                                                                 ram_usage));
      ...
      BOOST_REQUIRE_EXCEPTION(
         tester->push_action("testram11111"_n,
                             "setentry"_n,
                             "testram11111"_n,
                             mvo()("payer", "testram11111")("from", 1)("to", 10)("size", 1790 /*1920*/)),
         ram_usage_exceeded,
      ...
      // update the entries with smaller allocations so that we can verify space is freed and new allocations
      // can be made
      tester->push_action("testram11111"_n,
                          "setentry"_n,
                          "testram11111"_n,
                          mvo()("payer", "testram11111")("from", 1)("to", 10)("size", 1680 /*1810*/));
      produce_blocks(1);
      ...
      BOOST_REQUIRE_EXCEPTION(
         tester->push_action("testram11111"_n,
                             "setentry"_n,
                             "testram11111"_n,
                             mvo()("payer", "testram11111")("from", 1)("to", 11)("size", 1680 /*1810*/)),
         ram_usage_exceeded,
         fc_exception_message_starts_with("account testram11111 has insufficient ram"));
      produce_blocks(1);
      BOOST_REQUIRE_EQUAL(ram_usage - 1000, rlm.get_account_ram_usage("testram11111"_n));

      // verify the new entry's bytes minus the freed up bytes for existing entries still exceeds the
      // allocation bytes limit
      BOOST_REQUIRE_EXCEPTION(
         tester->push_action("testram11111"_n,
                             "setentry"_n,
                             "testram11111"_n,
                             mvo()("payer", "testram11111")("from", 1)("to", 11)("size", 1760)),
         ram_usage_exceeded,
         fc_exception_message_starts_with("account testram11111 has insufficient ram"));
      produce_blocks(1);
      BOOST_REQUIRE_EQUAL(ram_usage - 1000, rlm.get_account_ram_usage("testram11111"_n));

      // verify the new entry's bytes minus the freed up bytes for existing entries are under the allocation
      // bytes limit
      tester->push_action("testram11111"_n,
                          "setentry"_n,
                          "testram11111"_n,
                          mvo()("payer", "testram11111")("from", 1)("to", 11)("size", 1600 /*1720*/));
      produce_blocks(1);

      tester->push_action("testram11111"_n, "rmentry"_n, "testram11111"_n, mvo()("from", 3)("to", 3));
      produce_blocks(1);
      ...
      BOOST_REQUIRE_EXCEPTION(
         tester->push_action("testram11111"_n,
                             "setentry"_n,
                             "testram11111"_n,
                             mvo()("payer", "testram11111")("from", 12)("to", 12)("size", 1780)),
         ram_usage_exceeded,
         fc_exception_message_starts_with("account testram11111 has insufficient ram"));
      produce_blocks(1);
      ...
      tester->push_action("testram11111"_n,
                          "setentry"_n,
                          "testram11111"_n,
                          mvo()("payer", "testram11111")("from", 12)("to", 12)("size", 1620 /*1720*/));
      produce_blocks(1);
      ...
      BOOST_REQUIRE_EXCEPTION(
         tester->push_action("testram11111"_n,
                             "setentry"_n,
                             "testram11111"_n,
                             mvo()("payer", "testram11111")("from", 13)("to", 13)("size", 1660)),
         ram_usage_exceeded,
         fc_exception_message_starts_with("account testram11111 has insufficient ram"));
      produce_blocks(1);
      ...
      tester->push_action("testram11111"_n,
                          "setentry"_n,
                          { "testram11111"_n, "testram22222"_n },
                          mvo()("payer", "testram22222")("from", 12)("to", 12)("size", 1720));
      produce_blocks(1);

      // verify that another new entry that is too big will exceed the allocation bytes limit, to setup
      // testing of new payer
      BOOST_REQUIRE_EXCEPTION(
         tester->push_action("testram11111"_n,
                             "setentry"_n,
                             "testram11111"_n,
                             mvo()("payer", "testram11111")("from", 13)("to", 13)("size", 1900)),
         ram_usage_exceeded,
         fc_exception_message_starts_with("account testram11111 has insufficient ram"));
      produce_blocks(1);

      wlog("ram_tests 18    %%%%%%");
      // verify that the new entry is under the allocation bytes limit, because entry 12 is now charged to
      // testram22222
      tester->push_action("testram11111"_n,
                          "setentry"_n,
                          "testram11111"_n,
                          mvo()("payer", "testram11111")("from", 13)("to", 13)("size", 1720));
      produce_blocks(1);
      ...
      BOOST_REQUIRE_EXCEPTION(
         tester->push_action("testram11111"_n,
                             "setentry"_n,
                             { "testram11111"_n, "testram22222"_n },
                             mvo()("payer", "testram22222")("from", 12)("to", 21)("size", 1930)),
         ram_usage_exceeded,
      ...
      tester->push_action("testram11111"_n,
                          "setentry"_n,
                          { "testram11111"_n, "testram22222"_n },
                          mvo()("payer", "testram22222")("from", 12)("to", 21)("size", 1910));
      produce_blocks(1);
      ...
      BOOST_REQUIRE_EXCEPTION(
         tester->push_action("testram11111"_n,
                             "setentry"_n,
                             { "testram11111"_n, "testram22222"_n },
                             mvo()("payer", "testram22222")("from", 22)("to", 22)("size", 1910)),
         ram_usage_exceeded,
         fc_exception_message_starts_with("account testram22222 has insufficient ram"));
      produce_blocks(1);

      tester->push_action("testram11111"_n, "rmentry"_n, "testram11111"_n, mvo()("from", 20)("to", 20));
      produce_blocks(1);
