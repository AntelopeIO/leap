...
public:
   ...
   [[eosio::action]] void maintest() {
      ...
      ASSERT_EQ(params_object(0_ui).get(), params_object(0_ui));
      ...
      ASSERT_EQ(params_object({ 1_ui, 0_ui }).get(), params_object(1_ui)(0_ui)(1024 * 1024 * 2_64));
      ASSERT_EQ(old_way_params.max_block_net_usage, 1024 * 1024 * 2);

      params_object(1_ui)(1_ui)(20 * 100_32).set();
      get_blockchain_parameters(old_way_params);
      ASSERT_EQ(params_object({ 1_ui, 1_ui }).get(), params_object(1_ui)(1_ui)(20 * 100_32));
      ASSERT_EQ(old_way_params.target_block_net_usage_pct, 20 * 100);

      params_object(1_ui)(16_ui)(8_16).set();
      get_blockchain_parameters(old_way_params);
      ASSERT_EQ(params_object({ 1_ui, 16_ui }).get(), params_object(1_ui)(16_ui)(8_16));
      ASSERT_EQ(old_way_params.max_authority_depth, 8);

      params_object(3_ui)(0_ui)(1024 * 1024 * 3_64)(1_ui)(30 * 100_32)(16_ui)(10_16).set();
      get_blockchain_parameters(old_way_params);
      ASSERT_EQ(params_object({ 3_ui, 0_ui, 1_ui, 16_ui }).get(),
                params_object(3_ui)(0_ui)(1024 * 1024 * 3_64)(1_ui)(30 * 100_32)(16_ui)(10_16));
      ...
      params_object(17_ui)(0_ui)(1024 * 1024 * 4_64)(1_ui)(35 * 100_32)(2_ui)(1024 * 1024 * 2_32)(3_ui)(
         1024_32)(4_ui)(700_32)(5_ui)(50_32)(6_ui)(120_32)(7_ui)(250'000_32)(8_ui)(15 * 100_32)(9_ui)(
         230'000_32)(10_ui)(1000_32)(11_ui)(30 * 60_32)(12_ui)(15 * 60_32)(13_ui)(30 * 24 * 3600_32)(14_ui)(
         1024 * 1024_32)(15_ui)(6_16)(16_ui)(9_16)
         .set();
      get_blockchain_parameters(old_way_params);
      ASSERT_EQ(params_object({ 17_ui,
                                0_ui,
                                1_ui,
                                2_ui,
                                3_ui,
                                ...
                                16_ui })
                   .get(),
                params_object(17_ui)(0_ui)(1024 * 1024 * 4_64)(1_ui)(35 * 100_32)(2_ui)(1024 * 1024 * 2_32)(
                   3_ui)(1024_32)(4_ui)(700_32)(5_ui)(50_32)(6_ui)(120_32)(7_ui)(250'000_32)(8_ui)(
                   15 * 100_32)(9_ui)(230'000_32)(10_ui)(1000_32)(11_ui)(30 * 60_32)(12_ui)(15 * 60_32)(
                   13_ui)(30 * 24 * 3600_32)(14_ui)(1024 * 1024_32)(15_ui)(6_16)(16_ui)(9_16));
      ...
      ASSERT_EQ(params_object(1_ui)(17_ui).get(), params_object(1_ui)(17_ui)(256_32));
