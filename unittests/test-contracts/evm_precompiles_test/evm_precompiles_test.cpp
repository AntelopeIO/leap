#include "evm_precompiles_test.hpp"
#include <eosio/transaction.hpp>

using namespace eosio;
void evm_precompiles_test::testadd(const bytes& op1, const bytes& op2, int32_t expected_error, const bytes& expected_result) {
   bytes ret(64, '\0');
...
[[eosio::action]]
void evm_precompiles_test::testmul(const bytes& point, const bytes& scalar, int32_t expected_error, const bytes& expected_result) {
   bytes ret(64, '\0');
...
[[eosio::action]]
void evm_precompiles_test::testpair(const bytes& g1_g2_pairs, int32_t expected_error, bool expected_result) {
   bool ret = false;
...
[[eosio::action]]
void evm_precompiles_test::testmodexp(const bytes& base, const bytes& exp, const bytes& modulo, int32_t expected_error, const bytes& expected_result) {
...
[[eosio::action]]
void evm_precompiles_test::testblake2f( uint32_t rounds, const bytes& state, const bytes& message, const bytes& t0, const bytes& t1, bool final, int32_t expected_error, const bytes& expected_result) {
   bytes ret(64);
...
[[eosio::action]]
void evm_precompiles_test::testsha3(const bytes& input, const bytes& expected_result) {
   bytes ret(32);
...
[[eosio::action]]
void evm_precompiles_test::testkeccak(const bytes& input, const bytes& expected_result) {
   bytes ret(32);
...
[[eosio::action]]
void evm_precompiles_test::testecrec(const bytes& signature, const bytes& digest, int32_t expected_error, const bytes& expected_result) {
   bytes ret(65);
