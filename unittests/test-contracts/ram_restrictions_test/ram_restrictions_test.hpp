...
public:
   ...
   [[eosio::action]] void senddefer(uint64_t senderid, eosio::name payer);

   [[eosio::action]] void notifydefer(eosio::name acctonotify, uint64_t senderid, eosio::name payer);

   [[eosio::on_notify("tester2::notifydefer")]] void on_notifydefer(eosio::name acctonotify,
                                                                    uint64_t    senderid,
                                                                    eosio::name payer);
};
