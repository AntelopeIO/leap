...
public:
   ...
   [[eosio::action]] void sendinline(eosio::name authorizer);

   [[eosio::action]] void senddefer(eosio::name authorizer, uint32_t senderid);

   [[eosio::action]] void notifyinline(eosio::name acctonotify, eosio::name authorizer);
