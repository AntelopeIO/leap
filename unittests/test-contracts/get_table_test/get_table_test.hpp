...
public:
   ...
   typedef eosio::multi_index<"hashobjs"_n,
                              hashobj,
   ...
   [[eosio::action]] void addnumobj(uint64_t input);

   [[eosio::action]] void modifynumobj(uint64_t id);

   [[eosio::action]] void erasenumobj(uint64_t id);

   [[eosio::action]] void addhashobj(std::string hashinput);
};