...
public:
   ...
   {
      return push_action(issuer, "issue"_n, mvo()("to", to)("quantity", quantity)("memo", memo));
   }
...
try {
   ...
   BOOST_REQUIRE_EQUAL(success(), issue("alice"_n, "alice"_n, asset::from_string("1.000 TKN"), "hola"));
}
FC_LOG_AND_RETHROW()
