...
BOOST_DATA_TEST_CASE(conversions_0_check_throw, boost::unit_test::data::xrange(0, 67), index) {
   try {
      TESTER tester;
...
BOOST_DATA_TEST_CASE(conversions_0_pass, boost::unit_test::data::xrange(67, 71), index) {
   try {
      TESTER tester;
      tester.produce_block();
      tester.create_account("wasmtest"_n);
