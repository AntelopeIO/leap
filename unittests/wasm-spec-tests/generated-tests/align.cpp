...
BOOST_DATA_TEST_CASE(align_0_module, boost::unit_test::data::xrange(0, 1), index)
{
   try {
      TESTER tester;
...
BOOST_DATA_TEST_CASE(align_1_module, boost::unit_test::data::xrange(0, 1), index)
{
   try {
      TESTER tester;
      tester.produce_block();
...
BOOST_DATA_TEST_CASE(align_10_module, boost::unit_test::data::xrange(0, 1), index)
{
   try {
      TESTER tester;
      tester.produce_block();
...
BOOST_DATA_TEST_CASE(align_106_pass, boost::unit_test::data::xrange(0, 1), index)
{
   try {
      TESTER tester;
      tester.produce_block();
...
BOOST_DATA_TEST_CASE(align_107_check_throw, boost::unit_test::data::xrange(0, 1), index)
{
   try {
      TESTER tester;
      tester.produce_block();
...
BOOST_DATA_TEST_CASE(align_107_pass, boost::unit_test::data::xrange(1, 2), index)
{
   try {
      TESTER tester;
      tester.produce_block();
...
BOOST_DATA_TEST_CASE(align_11_module, boost::unit_test::data::xrange(0, 1), index)
{
   try {
      TESTER tester;
      tester.produce_block();
...
BOOST_DATA_TEST_CASE(align_12_module, boost::unit_test::data::xrange(0, 1), index)
{
   try {
      TESTER tester;
      tester.produce_block();
...
BOOST_DATA_TEST_CASE(align_13_module, boost::unit_test::data::xrange(0, 1), index)
{
   try {
      TESTER tester;
      tester.produce_block();
...
BOOST_DATA_TEST_CASE(align_14_module, boost::unit_test::data::xrange(0, 1), index)
{
   try {
      TESTER tester;
      tester.produce_block();
...
BOOST_DATA_TEST_CASE(align_15_module, boost::unit_test::data::xrange(0, 1), index)
{
   try {
      TESTER tester;
      tester.produce_block();
...
BOOST_DATA_TEST_CASE(align_16_module, boost::unit_test::data::xrange(0, 1), index)
{
   try {
      TESTER tester;
      tester.produce_block();
...
BOOST_DATA_TEST_CASE(align_17_module, boost::unit_test::data::xrange(0, 1), index)
{
   try {
      TESTER tester;
      tester.produce_block();
...
BOOST_DATA_TEST_CASE(align_18_module, boost::unit_test::data::xrange(0, 1), index)
{
   try {
      TESTER tester;
      tester.produce_block();
...
BOOST_DATA_TEST_CASE(align_19_module, boost::unit_test::data::xrange(0, 1), index)
{
   try {
      TESTER tester;
      tester.produce_block();
...
BOOST_DATA_TEST_CASE(align_2_module, boost::unit_test::data::xrange(0, 1), index)
{
   try {
      TESTER tester;
      tester.produce_block();
...
BOOST_DATA_TEST_CASE(align_20_module, boost::unit_test::data::xrange(0, 1), index)
{
   try {
      TESTER tester;
      tester.produce_block();
...
BOOST_DATA_TEST_CASE(align_21_module, boost::unit_test::data::xrange(0, 1), index)
{
   try {
      TESTER tester;
      tester.produce_block();
...
BOOST_DATA_TEST_CASE(align_22_module, boost::unit_test::data::xrange(0, 1), index)
{
   try {
      TESTER tester;
      tester.produce_block();
...
BOOST_DATA_TEST_CASE(align_3_module, boost::unit_test::data::xrange(0, 1), index)
{
   try {
      TESTER tester;
      tester.produce_block();
...
BOOST_DATA_TEST_CASE(align_4_module, boost::unit_test::data::xrange(0, 1), index)
{
   try {
      TESTER tester;
      tester.produce_block();
...
BOOST_DATA_TEST_CASE(align_5_module, boost::unit_test::data::xrange(0, 1), index)
{
   try {
      TESTER tester;
      tester.produce_block();
...
BOOST_DATA_TEST_CASE(align_6_module, boost::unit_test::data::xrange(0, 1), index)
{
   try {
      TESTER tester;
      tester.produce_block();
...
BOOST_DATA_TEST_CASE(align_7_module, boost::unit_test::data::xrange(0, 1), index)
{
   try {
      TESTER tester;
      tester.produce_block();
...
BOOST_DATA_TEST_CASE(align_8_module, boost::unit_test::data::xrange(0, 1), index)
{
   try {
      TESTER tester;
      tester.produce_block();
...
BOOST_DATA_TEST_CASE(align_9_module, boost::unit_test::data::xrange(0, 1), index)
{
   try {
      TESTER tester;
      tester.produce_block();
