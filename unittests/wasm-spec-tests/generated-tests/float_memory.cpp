...
BOOST_DATA_TEST_CASE(float_memory_0_pass, boost::unit_test::data::xrange(0, 1), index)
{
   try {
      TESTER tester;
...
BOOST_DATA_TEST_CASE(float_memory_1_pass, boost::unit_test::data::xrange(0, 1), index)
{
   try {
      TESTER tester;
      tester.produce_block();
...
BOOST_DATA_TEST_CASE(float_memory_2_pass, boost::unit_test::data::xrange(0, 1), index)
{
   try {
      TESTER tester;
      tester.produce_block();
...
BOOST_DATA_TEST_CASE(float_memory_3_pass, boost::unit_test::data::xrange(0, 1), index)
{
   try {
      TESTER tester;
      tester.produce_block();
...
BOOST_DATA_TEST_CASE(float_memory_4_pass, boost::unit_test::data::xrange(0, 1), index)
{
   try {
      TESTER tester;
      tester.produce_block();
...
BOOST_DATA_TEST_CASE(float_memory_5_pass, boost::unit_test::data::xrange(0, 1), index)
{
   try {
      TESTER tester;
      tester.produce_block();
